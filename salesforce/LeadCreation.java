...
public class LeadCreation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//input[@class=' input'])[4]")).sendKeys("Qeagle-opp");
		...
		driver.findElement(By.xpath("//input[@name='Lead-search-input']")).sendKeys("Lavanya",Keys.ENTER);
		...
		if(actMsg.equalsIgnoreCase(expMsg)) 		
			System.out.println("Lead has been converted to opportunity");					
		else 
			System.out.println("Lead has not been converted to opportunity");				
		WebElement opportunity = driver.findElement(By.xpath("//span[text()='Opportunities']"));
		driver.executeScript("arguments[0].click();", opportunity);
				
		//oppName
		driver.findElement(By.xpath("//input[@name='Opportunity-search-input']")).sendKeys("Qeagle-opp",Keys.ENTER);
